package org.killer.t0datafetch.modules.quartzAdmin.controller;

import org.killer.t0datafetch.modules.quartzAdmin.DateUnit;
import org.killer.t0datafetch.modules.quartzAdmin.entity.QrtzJobDetail;
import org.killer.t0datafetch.modules.quartzAdmin.entity.JobInfo;
...
public class QuartzJobController {
    ...
    public void addCronJob(JobInfo jobInfo) throws Exception {
        ...
        //构建job信息
        JobDetail jobDetail = JobBuilder.newJob(getClass(jobInfo.getJobClassName())).
    ...
    public Map<String, Object> queryjob(@RequestParam(value = "pageNum") Integer pageNum, @RequestParam(value = "pageSize") Integer pageSize) {
        Page<QrtzJobDetail> jobAndTrigger = iJobAndTriggerService.getJobAndTriggerDetails(pageNum, pageSize);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("JobAndTrigger", jobAndTrigger);
        map.put("number", jobAndTrigger.getTotalPages());
        return map;
    }
